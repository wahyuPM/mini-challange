...
const navbar = () => {
    return (
        <header className="fixed w-full z-50 px-4 bg-white">
            <div className="container mx-auto py-10">
                <div className="flex flex-stretch items-center">
                    ...
                    <div className="w-auto">
                        <ul
                            className="fixed bg-white inset-0 flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex">
                            <li className="mx-3 py-6 md:py-0">
                                <a href="#" className="text-black hover:text-white hover:underline">Login</a>
                            </li>
                            <li className="mx-3 py-6 md:py-0">
                                <a href="#" className="text-black hover:text-white hover:underline">Register</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul className="flex items-center">
                            <li className="ml-6 block md:hidden">
                                <button id="menu-toggler"
                                    className="relative flex z-50 items-center justify-center w-8 h-8 text-black hover:text-white focus:outline-none">
                                    <svg className="fill-current" width="18" height="17" viewBox="0 0 18 17" fill="none"
                            ...
                            <li className="ml-6">
                                <a href="cart.html" className="flex-items-center-justify-center w-8 h-8 text-black hover:text-white">
                                    <svg className="fill-current" width="29" height="25" viewBox="0 0 29 25" fill="none"
                                        ...
                                        <circle cx="25" cy="4.89023" r="4" fill="#F9CADA" className="cart-filled" />
                                    </svg>
